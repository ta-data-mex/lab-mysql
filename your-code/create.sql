...
CREATE TABLE customers (CustomerID int(5) primary key NOT NULL, CustomerName VARCHAR(50) NOT NULL, PhoneNumber VARCHAR(20) NOT NULL, Email VARCHAR(50), Address VARCHAR(50) NOT NULL, City VARCHAR(50) NOT NULL, State VARCHAR(50) NOT NULL, Country VARCHAR(50) NOT NULL, ZipCode VARCHAR(10) NOT NULL);
